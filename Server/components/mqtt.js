...
mqtt_connection.on('connect', function () {
    ...
    //         var message = new MQTTTaskMessage("ASSIGN", status, selection.userId, selection.userName, selection.taskId);
...
module.exports.publishTaskMessage = function publishTaskMessage(topic, message) {
